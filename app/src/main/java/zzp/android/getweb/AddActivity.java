...
public class AddActivity extends Activity {
    ...
    Boolean Downflag = true, OWFlag = false, MenuBtnFlag = false, SendMsgFlag = false;
    Thread Trun = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String strUrl, Bitmap favicon) {
                ...
                MenuBtnFlag = false;
                //通知MainTab更新menu状态
                Message.obtain(MainTabActivity.mHandler, 3, MenuBtnFlag).sendToTarget();
